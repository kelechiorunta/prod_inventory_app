...
export default function AppSearchBar() {
    return (
      <Navbar style={{position: 'absolute', top: 0, left: 0, zIndex: 50, width: '100%', padding: 'auto 71px'}} className='absolute top-0 left-0' bg="light" variant="dark" expand="lg" collapseOnSelect>
