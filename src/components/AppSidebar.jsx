        ...
        <Collapse in={open || window.innerWidth >= 992}>
          <div id="sidebar" className="p-3 border-end" style={{ minHeight: '100vh' }}>
            ...
            <Nav className="flex-column">
              <Nav.Link as={NavLink} to="/dashboard"><FaTachometerAlt className="me-2" />Dashboard</Nav.Link>
              <Nav.Link as={NavLink} to="page2"><FaBoxes className="me-2" />Inventory</Nav.Link>
            ...
            <Nav className="flex-column">
              ...
              <Nav.Link href="#"><FaCog className="me-2" />Settings</Nav.Link>
            </Nav>
          </div>
        </Collapse>
      </div>
